...
export function CreateArtikelModal({
    isOpen,
    onClose,
    onSubmit,
    isSubmitting,
    ...
    return (
        <Modal title="Tambah Artikel" isOpen={isOpen} onClose={onClose} onSubmit={handleSubmit} isSubmitting={isSubmitting}>
